...
function blackAndWhite(arr){
    ...
    let indexOfThirteen = arr.indexOf(13);
    if (indexOfFive > -1 && indexOfThirteen > -1) return "It's a black array";
    if (indexOfFive === -1 || indexOfThirteen === -1) return "It's a white array";
  }
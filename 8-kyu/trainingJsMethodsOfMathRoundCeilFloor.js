...
function roundIt(n){
    ...
    let numOfDigitsLeftOfDecimal = strNum.slice(0, indexOfDecimal).length;
    let numOfDigitsRightOfDecimal = strNum.slice(indexOfDecimal + 1).length;
    
    if (numOfDigitsLeftOfDecimal < numOfDigitsRightOfDecimal) {
      return Math.ceil(n)
    } else if (numOfDigitsLeftOfDecimal > numOfDigitsRightOfDecimal) {
      return Math.floor(n)
    } else {
      return Math.round(n)
    }
